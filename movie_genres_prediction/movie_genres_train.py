...
from model import CNN,LSTM,RESNET,CNN_LSTM_ADD,CNN_LSTM_concat,RESNET_LSTM_ADD,RESNET_LSTM_concat
...
# change different class to use different model
model = CNN_LSTM_concat(vocab_size, word2vec_embedding_matrix, hidden_dim, n_layers, output_size) 
model.to(device)
print(model)


filename = "result/resnet_lstm.txt"
